  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "BkcrWSB_NkJJA0IBCaG5X5pW-tE8rF9F8KuXtMAdB60",
      //.
      // 所在省份
      province: "上海",
      // 所在城市
...
//         {"type": "节日", "name": "订婚纪念日", "year": "2022", "date": "10-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        //{"type": "生日", "name": "小袁", "year": "1995", "date": "10-07"},
...
//     },
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "生日", "name": "小袁同学", "year": "2023", "date": "11-19", isShowAge: true},
    {"type": "生日", "name": "小王同学", "year": "2024", "date": "03-09", isShowAge: true},
